...
Meteor.publish('receiptsList', function () {
    return Receipts.find({}, { sort: { 'created.at': -1 }, limit: 15 })
})
...
Meteor.publish('receipts.Performance', function () {
    ...
    ReactiveAggregate(this, Receipts, pipeline, { clientCollection: 'monthlyreceipts' })
})
...
Meteor.publish('receipts.Details', function (date) {
    ...
    ReactiveAggregate(this, Receipts, pipeline, { clientCollection: 'detailsreceipt' })
})