  ...
  <Router history={browserHistory}>
    ...
    <Route path="/" component={App}>
      ...
      <Route
        ...
        component={DisbursementTransaction}
      />
      <Route
        path="/disbursements-monthly-performance"
        component={DisbursementsMonthlyPerformance}
      />
      <Route
      ...
      <Route
        path="/receipts-monthly-performance"
        component={ReceiptsMonthlyPerformance}
      />
      <Route
        path="/receipts-monthly-details"
        component={ReceiptsMonthlyDetails}
      />
