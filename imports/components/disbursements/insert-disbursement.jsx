...
export default class InsertDisbursement extends Component {
    ...
    _handleSubmit = () => (event) => {
        ...
        this.setState({ subcategory2: '', category: '', subcategory1: '', amount: '' })
    ...
    render() {
        ...
        return (
            <form className="ui form" onSubmit={this._handleSubmit()}>
                ...
                <div className="field">
                    <label>program</label>
                    <select className="ui fluid search dropdown"  value={subcategory2} onChange={this._selectProg()}>
                ...
                <div className="field">
                    ...
                    <select className="ui fluid search dropdown" name="type" value={subcategory1} onChange={this._selectSub()}>
