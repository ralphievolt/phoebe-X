...
export default class DisbursementsMonthlyDetails extends Component {
    ...
    _renderData = () => {
        ...
        return (
            <BarChart width={1100} height={400} data={this.props.disbursementDetails}
                ...
                <Bar name="DISBURSEMENTS" dataKey="amount" fill="#34b1c5" label={<CustomizedLabel />} />
            </BarChart>
        )
    }
    render() {
        ...
        return (
            <div id="content" className="ui main container">
                ...
                <div className="ui celled grid">
                    <h2>{month}  {year} Disbursements Details</h2>
                    {this._renderData()}
                </div>
                <div className="ui celled grid">
                    <h3>Raw Details</h3>
