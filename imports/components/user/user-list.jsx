                    ...
                    <tbody>
                        {this.props.userList.map((user, index) => (
                            <tr key={index}>
                                ...
                                <td>
                                    <div className="field">
                                        <select className="ui fluid dropdown" onChange={this._selectAccess()}>
                                 ...
                                 <td>
                                    <button className="ui grey basic mini button" value={user._id} onClick={this._updateAccess(event)}>
                                        update
                                    </button>
                                </td>
                                <td>
                                ...
                                <td>
                                    <button className="ui grey basic mini button" value={user._id} onClick={this._updateStatus(event)}>
                                        {user.status}
                                    </button>
                                </td>
                                <td>
